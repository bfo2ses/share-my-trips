...
| COR-011 | Drag des marqueurs d'étape cassé en édition : (1) en vue d'ensemble les coords partaient dans le pending du formulaire voyage au lieu de sauvegarder l'étape ; (2) icônes divIcon recréées à chaque render → swap d'icône en plein drag → crash Leaflet `baseVal`. Fix : garde pending restreint au formulaire de l'étape concernée + cache d'icônes | `[x]` corrigé dans [#46](https://github.com/bfo2ses/share-my-trips/pull/46) |
