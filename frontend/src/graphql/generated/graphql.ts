...
export type TripQuery = { __typename?: 'Query', trip?: { __typename?: 'Trip', id: string, title: string, country: string, description: string, startDate?: string | null, endDate?: string | null, status: TripStatus, coverPhoto: string } | null };
...
export type CreateTripMutation = { __typename?: 'Mutation', createTrip: { __typename?: 'TripPayload', trip?: { __typename?: 'Trip', id: string, title: string, country: string, description: string, startDate?: string | null, endDate?: string | null, status: TripStatus, coverPhoto: string } | null, errors: Array<{ __typename?: 'UserError', field?: string | null, message: string }> } };
...
export type UpdateTripMutation = { __typename?: 'Mutation', updateTrip: { __typename?: 'TripPayload', trip?: { __typename?: 'Trip', id: string, title: string, country: string, description: string, startDate?: string | null, endDate?: string | null, status: TripStatus, coverPhoto: string } | null, errors: Array<{ __typename?: 'UserError', field?: string | null, message: string }> } };
...
export type TripsQuery = { __typename?: 'Query', trips: Array<{ __typename?: 'Trip', id: string, title: string, country: string, startDate?: string | null, endDate?: string | null, status: TripStatus, coverPhoto: string }> };
